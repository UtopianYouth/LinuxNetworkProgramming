...
// 网站的根目录
const char* doc_root = "/home/utopiayouth/linux_study/webserver/resources";
...
bool HttpConnection::process_write(HTTP_CODE ret) {
    ...
    case BAD_REQUEST:
        ...
        if (add_content(error_400_form) == false) {
            return false;
        }
        break;
    case NO_RESOURCE:
        ...
        if (add_content(error_404_form) == false) {
            return false;
        }
        break;
    case FORBIDDEN_REQUEST:
        ...
        if (add_content(error_403_form) == false) {
            return false;
        }
        break;
    case FILE_REQUEST:
